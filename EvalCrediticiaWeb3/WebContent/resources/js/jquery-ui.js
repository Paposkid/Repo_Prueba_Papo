...
function Datepicker() {
	...
	/* ACA SE SETEAN LOS NOMBRES DEL DATAPICKER*/
	this.regional[""] = { // Default regional settings
		...
		monthNames: ["Enero","Febrero","Marzo","Abril","Mayo","Junio",
			"Julio","Agosto","Septiembre","Octobre","Noviembre","Diciembre"], // Names of months for drop-down and formatting
	...
	this._defaults = { // Global defaults for all the date picker instances
		...
		buttonText: "Seleccione una fecha", // Text for trigger button
