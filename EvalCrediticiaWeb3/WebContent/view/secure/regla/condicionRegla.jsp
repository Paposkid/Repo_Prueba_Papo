...
<script type="text/javascript">
	...
	function adicionar() {
		if ($("#idTextArea")[0].value != "") {
			...
			var campo = $("#idCampoEntrada option:selected").text().trim()
					+ " "
...
<div class="bodyExp">
	...
	<form:form id="frmReglaCondiciones" action="mostrarPaginaCondicionReglaLogico.do" commandName="reglaForm" method="POST">
		...
		<div class="grupoCamposExp">
			<table align="center">
				<tr class="campoCombo">
					<td><form:label path="condicionTO.campo.codigoCampo">
							<fmt:message key="regla.condicion.campoEntrada" />
						</form:label></td>
					<td><form:label path="condicionTO.operador">
							<fmt:message key="regla.condicion.operador" />
						</form:label>
					</td>
					<td><form:label path="condicionTO.tipo">
							<fmt:message key="general.tipo" />:
							</form:label>
					</td>
					<td id="idCategoriaLabel" style="display: none;"><form:label
							path="condicionTO.categoria.codigoCategoria">
							<fmt:message key="regla.condicion.categoria" />
						</form:label>
					</td>
					<td id="idDominioLabel" style="display: none;"><form:label
							path="condicionTO.constante.codigo">
				...
				<tr class="campoCombo">
					<td><form:select id="idCampoEntrada"
							path="condicionTO.campo.codigoCampo"
							onchange="activarOperador();">
							<form:option value="" selected="">
								<fmt:message key="general.combo.opcionInicial" />
							</form:option>
							<form:options items="${reglaForm.listaComboCampoEntrada}"
								itemLabel="nombreCampo" itemValue="codigoCampo" />
						</form:select>
					</td>
					<td><form:select id="idOperacionCombo"
							path="condicionTO.operador" onchange="verificarOperador(this);">
							<form:option value="" selected="">
								<fmt:message key="general.combo.opcionInicial" />
							</form:option>
					...
					<td><form:radiobutton id="idCheckCat" path="condicionTO.tipo"
							value="CAT" onclick="cambiarTipo(this);" /> <form:label
							path="condicionTO.tipo">
							<fmt:message key="regla.condicion.cat" />
						</form:label> <form:radiobutton id="idCheckCte" path="condicionTO.tipo"
					...
					<td id="idDominioSelect" style="display: none;"><form:select
							id="idComboDominio" path="condicionTO.constante.codigo">
						</form:select>
					</td>
					<td id="idConstanteSelect" style="display: none;"><form:select
							id="idComboConstante" path="condicionTO.constante.codigo">
							<form:option value="" selected="">
								<fmt:message key="general.combo.opcionInicial" />
							</form:option>
			...
			<div class="divBarraBotones">
				...
				<br />
				<form:textarea id="idTextArea" path="condicionTO.valor" cols="50"
					rows="10" />
				<div class="divBarraBotones">
					...
					<td>
						<table id="idTablaCondicion">
							<tr id="idTrCondicion" style="display: none;">
								...
								<td><input type="text" name="condiciones" size="40%">
								</td>
							</tr>
						</table></td>
				</tr>
