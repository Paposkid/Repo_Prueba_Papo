...
public class ParametroTO implements Serializable {
	...
	/**
	 * Atributo que identifica estado parametro. I-->Inactivo A-->Activo con Decodificación
	 */
	private String estadoDecode;
	...
	public String toString() {
		return "ParametroTO [codigoParametro=" + codigoParametro
				+ ", nombreParametro=" + nombreParametro + ", tipoParametro="
				+ tipoParametro + ", valorParametro=" + valorParametro
				+ ", estadoParametro=" + estadoParametro + ", fechaAlta="
				+ fechaAlta + ", codigoUsuarioAlta=" + codigoUsuarioAlta
				+ ", fechaModificacion=" + fechaModificacion
				+ ", codigoUsuario=" + codigoUsuario + ", estadoDecode="
				+ estadoDecode + "]";
	}

	/**
	 * @return the estadoDecode
	 */
	public String getEstadoDecode() {
		return estadoDecode;
	}

	/**
	 * @param estadoDecode the estadoDecode to set
	 */
	public void setEstadoDecode(String estadoDecode) {
		this.estadoDecode = estadoDecode;
	}
