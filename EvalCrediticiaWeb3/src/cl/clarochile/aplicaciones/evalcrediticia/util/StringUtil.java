...
public final class StringUtil {
	...
	/**
	 * <p>
	 * Une elementos de una colección mediante una cadena.
	 * 
	 * @param array
	 * @param delim
	 * @return Devuelve una cadena que contiene una representación de todos los
	 *         elementos de la colección en el mismo orden, pero con la cadena
	 *         <code>delim</code> en medio de los mismos.
	 */
	...
	/**
	 * <p>
	 * Completa una Cadena con el caracter dado hasta la longitud especificada.
	 * El caracter se agrega antes de la cadena. si <code>length</code> es menor
	 * que la longitud de <code>string</code> la cadena se devolvera sin cambios
	 * </p>
	 * 
	 * @param string
	 *            La cadena a completar
	 * @param complete
	 *            el caracter que llenara los espacios vacios
	 * @param length
	 *            la longitud que tendrá la nueva cadena
	...
	/**
	 * <p>
	 * Devuelve la cantidad de palabras de una cadena
	 * </p>
	 * <p>
	 * <code>String text = StringUtil.getWords("this is an example",2);</code>
	 * </p>
	 ...
	 * @param count
	 *            La cantidad de palabras a extraer
	 * @return el resultado de la busqueda, o <code>text</code> sin cambios si
