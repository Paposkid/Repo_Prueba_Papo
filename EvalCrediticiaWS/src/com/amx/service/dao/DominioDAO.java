...
public interface DominioDAO {
	...
	/**
	 * Método que permite obtener un dominio por nombre por medio de un mapeo a
	 * la DB
	 * 
	 * @param Map
	 *            <String, Object>
	 * @throws Exception 
	 */
	public void obtenerDominioPorNombre(Map<String, Object> dominioTO) throws Exception ;
